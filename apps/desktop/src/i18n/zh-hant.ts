...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    shiftClickHint: '右鍵點擊聊天以釘選 · 拖曳以重新排序',
    noWorkspace: '無工作區',
    projectEmpty: '尚無工作階段',
    noSessions: '尚無工作階段',
    ...
    row: {
      archiveSelected: count => `歸檔 ${count} 個對話`,
      deleteSelected: count => `刪除 ${count} 個對話`,
      deleteSelectedTitle: count => `刪除 ${count} 個對話？`,
      deleteSelectedDesc: count => `將永久刪除 ${count} 個對話，此操作無法復原。`,
      clearSelection: '清除選取',
      pin: '釘選',
      unpin: '取消釘選',
      markUnread: '標記為未讀',
  ...
  desktop: {
    ...
    archived: '已封存',
    archiveFailed: '封存失敗',
    archivedMany: count => `已歸檔 ${count} 個對話`,
    archiveFailedMany: count => `無法歸檔 ${count} 個對話`,
    deletedMany: count => `已刪除 ${count} 個對話`,
    deleteFailedMany: count => `無法刪除 ${count} 個對話`,
