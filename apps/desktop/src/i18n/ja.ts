...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    shiftClickHint: '右クリックでピン留め · ドラッグで並べ替え',
    ...
    row: {
      archiveSelected: count => `${count} 件をアーカイブ`,
      deleteSelected: count => `${count} 件を削除`,
      deleteSelectedTitle: count => `${count} 件を削除しますか？`,
      deleteSelectedDesc: count => `${count} 件のチャットを完全に削除します。取り消せません。`,
  ...
  desktop: {
    ...
    archivedMany: count => `${count} 件をアーカイブしました`,
    archiveFailedMany: count => `${count} 件のアーカイブに失敗しました`,
    deletedMany: count => `${count} 件を削除しました`,
    deleteFailedMany: count => `${count} 件の削除に失敗しました`,
