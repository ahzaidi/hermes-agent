...
export const en: Translations = {
  ...
  sidebar: {
    ...
    shiftClickHint: 'Right-click a chat to pin',
    ...
    row: {
      ...
      archiveSelected: count => `Archive ${count} chats`,
      deleteSelected: count => `Delete ${count} chats`,
      deleteSelectedTitle: count => `Delete ${count} chats?`,
      deleteSelectedDesc: count => `This will permanently delete ${count} chats. This cannot be undone.`,
