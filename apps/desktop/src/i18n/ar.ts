...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    shiftClickHint: 'انقر بزر الماوس الأيمن لتثبيت محادثة',
    ...
    row: {
      ...
      archiveSelected: count => `أرشفة ${count} محادثة`,
      deleteSelected: count => `حذف ${count} محادثة`,
      deleteSelectedTitle: count => `حذف ${count} محادثة؟`,
      deleteSelectedDesc: count => `سيؤدي هذا إلى حذف ${count} محادثة نهائيًا. لا يمكن التراجع عن ذلك.`,
  ...
  desktop: {
    ...
    archivedMany: count => `تمت أرشفة ${count} محادثة`,
    archiveFailedMany: count => `فشلت أرشفة ${count} محادثة`,
    deletedMany: count => `تم حذف ${count} محادثة`,
    deleteFailedMany: count => `فشل حذف ${count} محادثة`,
