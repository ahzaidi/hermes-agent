...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    shiftClickHint: '右键点击对话以置顶 · 拖动以重新排序',
    noWorkspace: '无工作区',
    projectEmpty: '暂无会话',
    noSessions: '暂无会话',
    ...
    row: {
      ...
      openInSplit: '在分屏中打开',
      archiveSelected: count => `归档 ${count} 个对话`,
      deleteSelected: count => `删除 ${count} 个对话`,
      deleteSelectedTitle: count => `删除 ${count} 个对话？`,
      deleteSelectedDesc: count => `将永久删除 ${count} 个对话，此操作无法撤销。`,
      clearSelection: '清除选择',
  ...
  desktop: {
    ...
    archived: '已归档',
    archiveFailed: '归档失败',
    archivedMany: count => `已归档 ${count} 个对话`,
    archiveFailedMany: count => `无法归档 ${count} 个对话`,
    deletedMany: count => `已删除 ${count} 个对话`,
    deleteFailedMany: count => `无法删除 ${count} 个对话`,
